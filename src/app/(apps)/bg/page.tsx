...
export default function BackgroundBuilderPage() {
  ...
  const [projects, setProjects] = useState<Project[]>([
    { id: 'p1', name: 'Background 1', formData: initialUniversalData, subjectRefs: [], styleRefs: [] }
  ]);
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      addGeneratedImage({ ...data, appType: 'bg', date: new Date().toISOString() });
    } catch (e) {
      ...
      >
         ...
         <div className="flex-1 overflow-y-auto custom-scrollbar pr-4">
            <UniversalFormCore 
              ...
              generateLabel={<><ImageIcon size={16}/> Forge Background</>}
            />
         </div>
